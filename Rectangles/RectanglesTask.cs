...
public static class RectanglesTask
{
    ...
    public static int IndexOfInnerRectangle(Rectangle r1, Rectangle r2)
    {
        if (AreIntersected(r1, r2))
        {
            if (IsFirstInSecond(r1, r2)) return 0;
            else if (IsSecondInFirst(r1, r2)) return 1;
        }
        return -1;
    }

    private static bool IsFirstInSecond(Rectangle r1, Rectangle r2)
    {
        return r1.Right <= r2.Right && r1.Left >= r2.Left && r1.Top >= r2.Top && r1.Bottom <= r2.Bottom;
    }

    private static bool IsSecondInFirst(Rectangle r1, Rectangle r2)
    {
